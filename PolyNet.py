...
class Stem(nn.Module):  # 用于对原始输入将采样
...
class BlockA(nn.Module):  # 输出通道数等于输入通道数
...
class BlockB(nn.Module):  # 输出通道数等于输入通道数
...
class BlockC(nn.Module):  # 输出通道数等于输入通道数
...
class ReductionA(nn.Module):  # 分辨率降低、通道数增加
...
class ReductionB(nn.Module):  # 分辨率降低、通道数增加
